...
const botname = process.env.BOTNAME || 'KRATOS-V9';
const antibot = process.env.ANTIBOT || 'FALSE';
    ...
    const author = process.env.STICKER_AUTHOR ||'V9';
    const packname = process.env.STICKER_PACKNAME || 'KRATOS';
...
if (antilink === 'TRUE' && antilinkall === 'TRUE' && body.includes('http') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`Auf wiedersehen:\n\n@${ki.split("@")[0]}, sending links is prohibited in this group!`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
    ...
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ KRATOS-V9 ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./kratos.jpg'),
                                sourceUrl: 'https://wa.me/254740782927?text=ʜᴇʟʟᴏ+𝐌𝐀𝐋𝐈𝐁𝐔+Nihostie+Bot+Mkuu+🥲',
                                mediaType: 1,
...
function _0x2de4() {
    const _0xca7309 = [
        ...
        'catch',
        'e\x20text.\x20Th',
        '\x20of\x20its developer 𝐒𝐎𝐌𝐈𝐘𝐀 𝐍𝐄𝐆𝐈',
        'is\x20AI\x20work',
        '1832596QZCVhJ',
        '\x20and\x20Googl',
        'AgaVJ',
...
let xf = m.quoted.text;
                ...
                let pppuser = await client.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/90b9b1b5010bed5ff9e21.jpg')
...
case "ping": case "speed": { 
 ...
 case "runtime": { 
                 m.reply (`KRATOS-V9 has been running for ${runtime(process.uptime())}`) 
 } 
 break;

case "alive": { 
  
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/fe8c712b7d6039b9a706a.jpg' }, caption: `Hello ${m.pushName}, 𝐊𝐑𝐀𝐓𝐎𝐒-𝐕9 is alive since  ${runtime(process.uptime())}`, fileLength: "9999999999898989899999999" }, { quoted: m }); 
 }
break;
case 'apk': {
...
case "movie": 
 ...
 break;
          ...
          case "kratos-v9": case "owner": case "somiya": 
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/fe8c712b7d6039b9a706a.jpg' }, caption: `Say no more 😌 here is 𝐒𝐎𝐌𝐈𝐘𝐀 contact +254740782927 🥱` }, {quoted: m}); 
 ...
 break
    ...
    break;
         ...
         for (let i of res) { 
             let txt = `</ KRATOS-V9 Broadcast >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}` 
             await client.sendMessage(i, { 
                 image: { 
                     url: "https://telegra.ph/file/90b9b1b5010bed5ff9e21.jpg" 
                 }, 
                 caption: `${txt}` 
             }) 
         } 
